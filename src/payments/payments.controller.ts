...
export class PaymentsController {
  ...
  @ApiHeader({
    ...
    description: "Xendit's webhook verification token",
  })
  @ApiResponse({
    status: 200,
    description:
      'Webhook received (always returns 200, even for unrecognized invoices)',
  })
  ...
  @ApiOperation({
    summary:
      'Get a single payment by id, with member/package details (owner only)',
  })
